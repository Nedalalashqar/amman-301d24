...
// 1. What is "this" when joe.scope() is invoked? the output will be object that have  'Joe', 'Schmoe', 100
//
// 2. What is "this" when joe.scopeArrow() is invoked? the output it will be realted Window object 
//
